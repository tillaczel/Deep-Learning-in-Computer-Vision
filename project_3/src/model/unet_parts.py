...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, dropout_rate=0, mid_channels=None):
        super().__init__()
        if not mid_channels:
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True, dropout_rate=0):
        ...
        if bilinear:
            ...
            self.conv = DoubleConv(in_channels, out_channels, mid_channels=in_channels // 2, dropout_rate=dropout_rate)
        else:
